                    ...
                    <form id="formsupplier" class="form-horizontal form-label-left" method="post" action="controller/doaddsupplier.php" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="customer_name" class="form-control col-md-7 col-xs-12" data-suggestions="White, Green, Blue, Black, Brown" name="customer_name" placeholder="Ex. PT.Integrasi Solution" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="alamat" name="alamat" class="form-control col-md-7 col-xs-12" placeholder="Jakarta" type="text">
                        </div>
                      </div>
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="hp" name="hp" required="required" min="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
